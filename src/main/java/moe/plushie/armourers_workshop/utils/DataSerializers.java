...
public class DataSerializers {
    ...
    public static final IEntitySerializer<Integer> INT = new IEntitySerializer<Integer>() {
        @Override
    ...
    public static final IEntitySerializer<Float> FLOAT = new IEntitySerializer<Float>() {
        @Override
    ...
    public static final IEntitySerializer<String> STRING = new IEntitySerializer<String>() {
        @Override
